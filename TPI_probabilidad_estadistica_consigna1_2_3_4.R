...
#####################################################################
# Consigna 1: cargar y preparar datos
##################################################################
...
tabla_sat$Categoria <- reorder(tabla_sat$Categoria, -tabla_sat$porc)

########################################################
# Consiga 3: Medidas descriptivas
######################################################
...
cat("Moda:", moda_horas, "\n")
cat("Cuartiles:\n"); print(cuartiles_horas)
cat("Rango:", rango_horas, "\n")
cat("Varianza:", round(varianza_horas, 2), "\n")
cat("Desvío estándar:", round(desvio_horas, 2), "\n")
...
cat("Cuartiles (categorías):\n"); print(cuartiles_sat_labels)

##########################################################################
# Consigna 4: Representación gráfica
##########################################################################
...
ggplot(data.frame(horas), aes(x = horas)) +
  ...
  labs(
    title = "Histograma de horas semanales de estudio",
    x = "Horas de estudio",
